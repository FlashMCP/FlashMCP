"""Provides a base mixin class and decorators for easy registration of class methods with FlashMCP."""
...
class MCPMixin:
    ...
    with a FlashMCP server instance using decorators.
    ...
    register them with the provided FlashMCP server instance.
    """
    ...
    def register_tools(
        ...
        """Registers all methods marked with @mcp_tool with the FlashMCP server.

        Args:
            mcp_server: The FlashMCP server instance to register tools with.
    ...
    def register_resources(
        ...
        """Registers all methods marked with @mcp_resource with the FlashMCP server.

        Args:
            mcp_server: The FlashMCP server instance to register resources with.
    ...
    def register_prompts(
        ...
        """Registers all methods marked with @mcp_prompt with the FlashMCP server.

        Args:
            mcp_server: The FlashMCP server instance to register prompts with.
    ...
    def register_all(
        ...
        Args:
            mcp_server: The FlashMCP server instance to register with.
