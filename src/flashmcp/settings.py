    ...
    client_raise_first_exceptiongroup_error: Annotated[
        ...
        Field(
            ...
            description=inspect.cleandoc(
                ...
                ExceptionGroups instead of exceptions. If this setting is True, FlashMCP Clients
    ...
    resource_prefix_format: Annotated[
        ...
        Field(
            ...
            description=inspect.cleandoc(
                ...
                or protocol formatting (prefix+resource://path). Protocol formatting was the default in FlashMCP < 2.4;
