...
from FlashMCP.client.client import ClientTransport, SessionKwargs
from FlashMCP.client.sse import SSETransport
from FlashMCP.client.streamable_http import StreamableHttpTransport
...
def infer_transport(
    transport: ClientTransport | FlashMCPServer | AnyUrl | Path | dict[str, Any] | str,
) -> ClientTransport:
    """
    ...
    # the transport is a FlashMCP server
        ...
        return FlashMCPTransport(mcp=transport)
