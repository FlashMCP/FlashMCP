"""Provides a base class and decorators for easy registration of class methods with FlashMCP."""
...
class McpRegisterable:
    ...
    def register_tools(self, mcp_server: "FlashMCP", prefix: str | None = None) -> None:
    ...
    def register_resources(
        self, mcp_server: "FlashMCP", prefix: str | None = None
    ) -> None:
