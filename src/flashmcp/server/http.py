...
def create_sse_app(
    ...
    Args:
        server: The FlashMCP server instance
    ...
    # Store the FlashMCP server instance on the Starlette app state
    app.state.FlashMCP_server = server
        ...
        try:
            ...
            if "Task group is not initialized" in str(e):
                new_error_message = (
                    ...
                    "This commonly occurs when the FlashMCP application's lifespan is not "
                    ...
                    "returned by `FlashMCP_instance.http_app()`. \\n"
                    "For more details, see the FlashMCP ASGI integration documentation: "
                    "https://goFlashMCP.com/deployment/asgi"
                )
