...
import FlashMCP.server.dependencies
...
class Context:
    ...
    def __init__(self, FlashMCP: FlashMCP):
        self.FlashMCP = FlashMCP
    ...
    def request_context(self) -> RequestContext:
        ...
        return self.FlashMCP._mcp_server.request_context
    ...
    async def read_resource(self, uri: str | AnyUrl) -> list[ReadResourceContents]:
        ...
        """
        assert self.FlashMCP is not None, "Context is not available outside of a request"
        return await self.FlashMCP._mcp_read_resource(uri)
