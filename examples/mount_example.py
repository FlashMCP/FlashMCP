"""Example of mounting FlashMCP apps together.

This example demonstrates how to mount FlashMCP apps together using
...
weather_app = FlashMCP("Weather App")
