# /// script
# dependencies = ["FlashMCP"]
# ///

"""
FlashMCP Text Me Server
--------------------------------
This defines a simple FlashMCP server that sends a text message to a phone number via https://surgemsg.com/.
