"""
Modular FlashMCP Application Example

This example demonstrates building a modular application with FlashMCP
...
# ----- ANALYTICS MODULE -----
analytics_app = FlashMCP("Analytics Module")
...
# ----- FILESYSTEM MODULE -----
files_app = FlashMCP("Filesystem Module")
...
main_app = FlashMCP("Modular FlashMCP Demo")
...
if __name__ == "__main__":
    ...
    # Start the server
    print("Starting modular FlashMCP application...")
    main_app.run()
