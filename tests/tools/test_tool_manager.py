...
from FlashMCP import Context, FlashMCP, Image
from FlashMCP.exceptions import NotFoundError, ToolError
...
class TestCallTools:
    ...
    async def test_call_tool_with_custom_serializer(self):
        """Test that a custom serializer provided to FlashMCP is used by tools."""
    ...
    async def test_call_tool_with_list_result_custom_serializer(self):
        """Test that a custom serializer provided to FlashMCP is used by tools that return lists."""
