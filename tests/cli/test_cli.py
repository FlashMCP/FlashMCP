...
class TestHelperFunctions:
    ...
    def test_build_uv_command_basic(self):
        ...
        assert cmd == ["uv", "run", "--with", "FlashMCP", "FlashMCP", "run", "file.py"]
    ...
    def test_build_uv_command_with_editable(self):
        ...
        assert cmd == [
            "uv", "run", "--with", "FlashMCP", 
            "--with-editable", "/path/to/project",
            "FlashMCP", "run", "file.py"
        ]
...
class TestDevCommand:
    ...
    def test_dev_command_success(self, temp_python_file, mock_logger):
        ...
        with patch("FlashMCP.cli.cli._parse_file_path") as mock_parse, \
             patch("FlashMCP.cli.cli._import_server") as mock_import, \
             patch("FlashMCP.cli.cli._get_npx_command") as mock_get_npx, \
             patch("FlashMCP.cli.cli._build_uv_command") as mock_build_uv, \
