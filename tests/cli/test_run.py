...
from FlashMCP.cli.cli import app
...
def test_cli_run_transport_kwargs():
    ...
    with (
        patch("FlashMCP.cli.cli._parse_file_path") as mock_parse_file_path,
        patch("FlashMCP.cli.cli._import_server") as mock_import_server,
    ):
        ...
        mock_server = FlashMCP(name="MockServer")
