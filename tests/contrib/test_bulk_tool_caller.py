...
def live_server_with_tool() -> FlashMCP:
    """Fixture to create a FlashMCP server instance with the echo_tool registered."""
    server = FlashMCP()
...
@pytest.fixture
def bulk_caller_live(live_server_with_tool: FlashMCP) -> BulkToolCaller:
