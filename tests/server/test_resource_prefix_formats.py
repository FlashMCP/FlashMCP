...
async def test_resource_prefix_format_in_constructor():
    ...
    server_path = FlashMCP("PathFormat", resource_prefix_format="path")
    server_protocol = FlashMCP("ProtocolFormat", resource_prefix_format="protocol")
    ...
    main_server_path = FlashMCP("MainPath", resource_prefix_format="path")
    main_server_protocol = FlashMCP("MainProtocol", resource_prefix_format="protocol")
