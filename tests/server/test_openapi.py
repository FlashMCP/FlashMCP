...
class TestTools:
    ...
    async def test_call_create_user_tool(
        ...
        """
        tool_response = await FlashMCP_openapi_server.call_tool(
...
class TestTagTransfer:
    ...
    async def test_tags_transferred_to_resources(
        ...
        resources = FlashMCP_openapi_server._resource_manager.list_resources()
    ...
    async def test_tags_transferred_to_resource_templates(
        ...
        templates = FlashMCP_openapi_server._resource_manager.list_templates()
