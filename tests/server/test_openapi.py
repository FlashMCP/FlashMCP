...
class TestTools:
    async def test_list_tools(self, FlashMCP_openapi_server: FlashMCPOpenAPI):
        ...
        """
        tools = await FlashMCP_openapi_server._mcp_list_tools()
        assert len(tools) == 2
    ...
    async def test_call_create_user_tool(
        ...
        """
        tool_response = await FlashMCP_openapi_server._mcp_call_tool(
        ...
        user_response = await FlashMCP_openapi_server._mcp_read_resource(
...
class TestResources:
    async def test_list_resources(self, FlashMCP_openapi_server: FlashMCPOpenAPI):
        ...
        """
        resources = await FlashMCP_openapi_server._mcp_list_resources()
    ...
    async def test_get_resource(
        ...
        resource_response = await FlashMCP_openapi_server._mcp_read_resource(
...
class TestResourceTemplates:
    async def test_list_resource_templates(
        ...
        """
        resource_templates = await FlashMCP_openapi_server._mcp_list_resource_templates()
...
class TestPrompts:
    async def test_list_prompts(self, FlashMCP_openapi_server: FlashMCPOpenAPI):
        ...
        """
        prompts = await FlashMCP_openapi_server._mcp_list_prompts()
