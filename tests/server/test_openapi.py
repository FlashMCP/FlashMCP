...
class TestTools:
    async def test_list_tools(self, FlashMCP_server: FlashMCPOpenAPI):
        ...
        """
        tools = await FlashMCP_server.list_tools()
        assert len(tools) == 2
    ...
    async def test_call_create_user_tool(
        ...
        user_response = await FlashMCP_server.read_resource(
...
class TestResources:
    async def test_list_resources(self, FlashMCP_server: FlashMCPOpenAPI):
        ...
        """
        resources = await FlashMCP_server.list_resources()
    ...
    async def test_get_resource(
        ...
        resource_response = await FlashMCP_server.read_resource(
...
class TestResourceTemplates:
    async def test_list_resource_templates(self, FlashMCP_server: FlashMCPOpenAPI):
        ...
        """
        resource_templates = await FlashMCP_server.list_resource_templates()
...
class TestPrompts:
    async def test_list_prompts(self, FlashMCP_server: FlashMCPOpenAPI):
        ...
        """
        prompts = await FlashMCP_server.list_prompts()
