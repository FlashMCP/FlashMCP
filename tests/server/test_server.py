...
from FlashMCP.server.server import (
    MountedServer,
    add_resource_prefix,
    has_resource_prefix,
...
class TestTools:
    ...
    async def test_remove_tool_successfully(self):
        """Test that FlashMCP.remove_tool removes the tool from the registry."""
...
class TestResourcePrefixMounting:
    ...
    async def test_mounted_server_resource_prefixing(self):
        ...
        server = FlashMCP(name="ResourceServer")
        ...
        main_server = FlashMCP(name="MainServer")
    ...
    async def test_import_server_with_new_prefix_format(self):
        ...
        # Create a server with resources
        source_server = FlashMCP(name="SourceServer")
        ...
        target_server = FlashMCP(name="TargetServer")
