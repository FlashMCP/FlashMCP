...
class TestTools:
    ...
    async def test_list_tools_same_as_original(self, FlashMCP_server, proxy_server):
        assert await proxy_server.list_tools() == await FlashMCP_server.list_tools()
...
class TestResources:
    ...
    async def test_list_resources_same_as_original(self, FlashMCP_server, proxy_server):
        assert (
            await proxy_server.list_resources() == await FlashMCP_server.list_resources()
        )
...
class TestResourceTemplates:
    ...
    async def test_list_resource_templates_same_as_original(
        ...
        result = await FlashMCP_server.list_resource_templates()
...
class TestPrompts:
    ...
    async def test_list_prompts_same_as_original(self, FlashMCP_server, proxy_server):
        assert await proxy_server.list_prompts() == await FlashMCP_server.list_prompts()
