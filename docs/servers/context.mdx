...
When defining FlashMCP [Tools](/server/tools), your functions might need to interact with the underlying MCP session or access server capabilities. FlashMCP provides the `Context` object for this purpose.
