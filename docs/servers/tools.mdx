...
2.  Allow FlashMCP to validate the data received from the client.
3.  Are used to generate the tool's input schema for the MCP protocol.

FlashMCP supports standard Python type annotations, including those from the `typing` module and Pydantic.
