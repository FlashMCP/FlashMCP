...
FlashMCP allows you to compose complex applications by mounting other FlashMCP servers as subservers. This is useful for:

- Organizing large applications into logical components
- Reusing existing FlashMCP servers as parts of a larger system
